...
const AbsiDetailTerimaMutasi = ({ route, navigation }) => {
  const [dataArtikel] = useState([
    { kodeArtikel: 'FG-HXKL-205MX-C', namaArtikel: 'Hicoop Boxer Karet Luar Mix Max Seri 2-1 (L)', jumlah: '10' },
    { kodeArtikel: 'FG-HXKL-205MX-C', namaArtikel: 'Hicoop Boxer Karet Luar Mix Max Seri 2-1 (L)', jumlah: '10' },
    { kodeArtikel: 'FG-HXKL-205MX-C', namaArtikel: 'Hicoop Boxer Karet Luar Mix Max Seri 2-1 (L)', jumlah: '10' },
    { kodeArtikel: 'FG-HXKL-205MX-C', namaArtikel: 'Hicoop Boxer Karet Luar Mix Max Seri 2-1 (L)', jumlah: '10' },
    { kodeArtikel: 'FG-HXKL-205MX-C', namaArtikel: 'Hicoop Boxer Karet Luar Mix Max Seri 2-1 (L)', jumlah: '10' },
    ...
    <View style={styles.container}>
      <View style={styles.form}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerBottom}>Dari: {toko}</Text>
        </View>
            ...
            <View key={index} style={styles.card}>
              <View style={styles.cardRow}>
                <View style={styles.cardColumn}>
                  ...
                  <Text style={styles.cardText3}>{`Jumlah yang di kirim: ${barang.jumlah}`}</Text>
                </View>
                <TextInput
                  maxLength={3}
...
export default AbsiDetailTerimaMutasi;